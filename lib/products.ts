...
export const products = {
  tech: [
    ...
    },
    {
      ...
      minQuantity: 1,
      hasWarranty: "1 MES GARANTÍA",
      image: "/products/redmi-15c.png",
    },
    {
      id: "iphone-13",
  ...
  accessories: [
    ...
    },
    {
      ...
      priceTiers: [
        ...
        { quantity: 30, price: 5.5, currency: "USD" as const },
        { quantity: 50, price: 5, currency: "USD" as const },
        { quantity: 100, price: 4.5, currency: "USD" as const },
      ],
    },
    ...
    {
      id: "fundas-silicona",
      name: "Fundas Silicona",
      subtitle: "MANZANA · VARIOS MODELOS",
      basePrice: 2,
      currency: "USD" as const,
      minQuantity: 5,
      image: "/products/fundas-silicona.png",
    },
  ],
  perfumery: [
    {
    ...
    {
      id: "body-splash-arabe-mujer",
      name: "Body Splash Árabe",
      subtitle: "MUJER · +10 FRAGANCIAS",
      basePrice: 11000,
      currency: "ARS" as const,
      minQuantity: 2,
      badge: "mejor precio",
      image: "/products/body-splash-arabe-mujer.png",
      priceTiers: [
        { quantity: 2, price: 16500, currency: "ARS" as const },
        { quantity: 5, price: 16000, currency: "ARS" as const },
        { quantity: 10, price: 14500, currency: "ARS" as const },
        { quantity: 20, price: 13500, currency: "ARS" as const },
        { quantity: 30, price: 12500, currency: "ARS" as const },
        { quantity: 50, price: 12000, currency: "ARS" as const },
        { quantity: 100, price: 11000, currency: "ARS" as const },
      ],
    },
    {
      id: "body-splash-arabe-hombre",
      name: "Body Splash Árabe",
      subtitle: "HOMBRE · +10 FRAGANCIAS",
      basePrice: 11000,
      currency: "ARS" as const,
      minQuantity: 2,
      badge: "mejor precio",
      image: "/products/body-splash-arabe-hombre.png",
      priceTiers: [
        { quantity: 2, price: 16500, currency: "ARS" as const },
        { quantity: 5, price: 16000, currency: "ARS" as const },
        { quantity: 10, price: 14500, currency: "ARS" as const },
  ...
  vapes: [
    {
      id: "elfbar-40000",
      name: "Elfbar 40.000 Puff — Trío",
      subtitle: "+10 SABORES DISPONIBLES · CONSULTÁ STOCK",
      basePrice: 14,
      currency: "USD" as const,
      minQuantity: 5,
  ...
  resale: [
    {
      id: "iphone-13-resale",
      name: "iPhone 13",
      subtitle: "128GB · BATERÍA +85% · CALIDAD A",
      basePrice: 330,
      currency: "USD" as const,
      minQuantity: 1,
      badge: "TOP",
      hasWarranty: "30 DÍAS GARANTÍA",
      image: "/products/iphone-13.png",
    },
    {
      id: "iphone-14-pro",
      name: "iPhone 14 Pro",
      subtitle: "256GB · BATERÍA +85% · GRADO A / -A",
      basePrice: 470,
      currency: "USD" as const,
      minQuantity: 1,
    ...
    },
    {
      id: "iphone-15",
      name: "iPhone 15",
      subtitle: "128GB · BATERÍA +85% · GRADO A / -A",
      basePrice: 440,
      currency: "USD" as const,
      minQuantity: 1,
