      ...
      <div className="p-2.5 sm:p-4 flex flex-col flex-grow">
          ...
          {product.features && product.features.length > 0 && (
            <ul className="mb-4 space-y-1.5 border-t border-border/50 pt-3">
              {product.features.map((feature, idx) => (
                <li key={idx} className="flex items-start gap-1.5 text-xs text-muted-foreground leading-tight">
        ...
        {product.isConsultOnly ? (
          <div className="mt-4 pt-3 border-t border-border/50">
            <a
              href={`https://wa.me/5491122813943?text=Hola%20Dylan,%20quiero%20consultar%20por%20los%20perfumes%20%C3%A1rabes%20en%20stock`}
              target="_blank"
            ...
            {quantityOptions.length > 1 && (
              <div className="mb-2">
                ...
                <select
                  ...
                  className="w-full bg-secondary/50 border border-border/50 rounded-lg px-2 py-2 text-xs text-foreground focus:outline-none focus:ring-1 focus:ring-primary appearance-none cursor-pointer min-h-[40px]"
